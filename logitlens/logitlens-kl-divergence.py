...
def main():
    ...
    parser.add_argument("--n_problems", type=int, default=500, help="Number of problems to process")
    parser.add_argument("--max_length", type=int, default=1024, help="Max length for tokenizer")
    parser.add_argument("--output_prefix", type=str, default="kl_divergence", help="Output prefix for the plots")
    ...
    for MODEL_NAME in MODEL_NAMES:
        ...
        def kl_per_prompt(text, model=model, tokenizer=tokenizer):
            layer_logits = []
        ...
        # )
        plt.title(f"{MODEL_NAME} – Average LogitLens KL vs Layer")
        ...
        output_file = f"{args.output_prefix}_{model_suffix}.png"
